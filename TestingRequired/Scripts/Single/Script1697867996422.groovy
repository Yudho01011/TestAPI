...
//find object repo for api testing and execute it
responBody = WS.sendRequest(findTestObject("SingleUser"))

//verify respon body and code
WS.verifyResponseStatusCode(responBody, 200)

//get property of respon in map form
Map user = responBody.getProperties()

//initialization json sluper for parse json form to map value
def jsonPlur = new JsonSlurper()
def bodyRespon = jsonPlur.parseText(user['responseText'])

//assign value of email to global variable
